...
public class NotificacionInBrowserResourceIntTest {
    ...
    public void createNotificacionInBrowser() throws Exception {
        ...
        assertThat(testNotificacionInBrowser.getFechaCreado()).isEqualTo(DEFAULT_FECHA_CREADO);
        assertThat(testNotificacionInBrowser.getDescripcion()).isEqualTo(DEFAULT_DESCRIPCION);
    ...
    public void checkFechaCreadoIsRequired() throws Exception {
        ...
        // set the field null
        notificacionInBrowser.setFechaCreado(null);
    ...
    public void updateNotificacionInBrowser() throws Exception {
        ...
        NotificacionInBrowser testNotificacionInBrowser = notificacionInBrowserList.get(notificacionInBrowserList.size() - 1);
        assertThat(testNotificacionInBrowser.getFechaCreado()).isEqualTo(UPDATED_FECHA_CREADO);
        assertThat(testNotificacionInBrowser.getDescripcion()).isEqualTo(UPDATED_DESCRIPCION);
