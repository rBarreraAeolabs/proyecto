...
//        List<MovimientoProvidencia> traerMovimientos(@Param("Id") Long Id);
    ...
    @Query(value = "SELECT * FROM movimiento_providencia m where m.providencia_id =:id  order by m.fecha", nativeQuery = true)
    Set<MovimientoProvidencia> traerMovimientos(@Param("id") Long id);
    ...
    MovimientoProvidencia traerMovi(@Param("id") Long id);

    @Query(value = "SELECT * FROM movimiento_providencia m where m.providencia_id =:id  order by m.fecha", nativeQuery = true)
    List <MovimientoProvidencia> traerMovimiento(@Param("id") Long id);
