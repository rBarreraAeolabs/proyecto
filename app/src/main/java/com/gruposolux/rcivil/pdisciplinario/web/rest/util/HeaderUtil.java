package com.gruposolux.rcivil.pdisciplinario.web.rest.util;
...
public final class HeaderUtil {
    ...
    public static HttpHeaders createEntityCreationAlert(String entityName, String param) {
        return createAlert("Un nuevo " + entityName + " se crea con identificador " + param, param);
    }

    public static HttpHeaders createEntityUpdateAlert(String entityName, String param) {
        return createAlert("Un " + entityName + " se actualiza con identificador " + param, param);
    }
