...
//            .event(AccionesProvidencia.FISCAL_ADJUNTA_MEMO.name()).event(AccionesProvidencia.ENVIA_A_UPD.name())
  ...
  //  ------------------------------------------  FLUJO ESPECIFICO PARA PROVIDENCIA SOBRECEDER --------------------------------------------
            ...
            .event(AccionesProvidencia.FLUJO_SOBRESEER.name())
            .and()
            .withExternal()
            ...
            .and()
            .withExternal()
            .source(EstadoProvidencia.ESPERANDO_FIRMA_DEL_DN.name()).target(EstadoProvidencia.RECIBE_SJ_PARA_MEMO.name())
            .event(AccionesProvidencia.FLUJO_SOBRESEER.name())
            .and()
            .withExternal()
            ...
            .event(AccionesProvidencia.ASIGNA_FOLIO.name())
