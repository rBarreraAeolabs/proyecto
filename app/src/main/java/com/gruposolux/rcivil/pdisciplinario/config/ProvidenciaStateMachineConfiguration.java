...
//            .event(AccionesProvidencia.FISCAL_RECHAZA.name())
            ...
            .and()
            /**
             * Estados en los que se puede cambiar a proroga y seleccion Fiscal.
             *
             */
//            .withExternal()
//            .source(EstadoProvidencia.SECRETARIA_REVISA_NUMERO.name()).target(EstadoProvidencia.FISCAL_NOTIFICADO.name())
//            .event(AccionesProvidencia.SELECCION_FISCAL.name())
////            .event(AccionesProvidencia.GESTOR_DOCUMENTAL_ASIGNO_NUMERO.name())
//            .and()
            .withExternal()
...
//            .event(AccionesProvidencia.FISCAL_ADJUNTA_MEMO.name()).event(AccionesProvidencia.ENVIA_A_UPD.name())
  ...
  //  ------------------------------------------  FLUJO ESPECIFICO PARA PROVIDENCIA SOBRECEDER --------------------------------------------
            ...
            .and()
            .withExternal()
            .source(EstadoProvidencia.RECIBE_SJ_PARA_MEMO.name()).target(EstadoProvidencia.REDACCION_MEMO.name())
            .event(AccionesProvidencia.FLUJO_SOBRESEER_ABSOLVER.name())
            .and()
            .withExternal()
            .source(EstadoProvidencia.REDACCION_MEMO.name()).target(EstadoProvidencia.DEMANDADO_NOTIFICADO.name())
