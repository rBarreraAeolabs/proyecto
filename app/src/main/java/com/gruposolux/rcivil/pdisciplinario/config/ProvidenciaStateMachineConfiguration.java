...
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SJ_RECEPCIONA_APELACION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SECRETARIA_REVISA_APELACION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.ASIGNANDO_ABOGADO_A_APELACION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.ABOGADO_ELABORA_INFORME_APELACION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SECRETARIA_REVISA_INFORME_APELACION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SUBDIRECCION_REVISA_INFORME_APELACION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SECRETARIA_DESPACHA_INFORME_APELACION_A_DGD.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.DGD_DESPACHA_INFORME_APELACION_A_DN.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.DN_EMITE_PROVIDENCIA.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.PROVIDENCIA_EN_SJ.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.REVISION_DE_PROVIDENCIA.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.REVISION_DE_PROVIDENCIA.name())
...
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SD_ASIGNA_REDACCION_RESOLUCION_MEMO.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SECRETARIA_REVISA_ASIGNACION_REDACCION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.REDACCION_RESOLUCION_MEMO_UPD.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SECRETARIA_REVISA_REDACCION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.VISA_Y_FIRMA_SUBDIRECCION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SECRETARIA_REVISA_VISA_Y_FIRMA_SUBDIRECCION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.DESPACHA_A_DN.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.DN_FIRMA_RESOLUCION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.DGDP_ASIGNA_NUMERO.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SJ_RECIBE_RESOLUCION_CON_NUMERO.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.REDACCION_DE_RESOLUCION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SECRETARIA_REVISA_RESOLUCION.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            .withExternal()
//            .source(EstadoProvidencia.SE_NOTIFICO_INCULPADO.name()).target(EstadoProvidencia.SUBDIRECCION_VISA_FIRMA.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
//            //          SOLO SI LE DIO AL BOTON REALIZAR MEMO CONDUCTO ES QUE PUEDE MOVERSE AL OTRO ESTADO
//            .withExternal()
//            .source(EstadoProvidencia.REALIZADO_MEMO_CONDUCTOR.name()).target(EstadoProvidencia.SECRETARIA_REVISA_VISA_FIRMA_MEMO_CONDUCTO.name())
//            .event(AccionesProvidencia.FLUJO_APELA.name())
//            .and()
