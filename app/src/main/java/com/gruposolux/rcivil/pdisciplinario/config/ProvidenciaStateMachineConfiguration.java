...
//                .and()
                ...
                .and()
                .withExternal()
                .source(EstadoProvidencia.REVISA_PROVIDENCIA_.name()).target(EstadoProvidencia.ASIGNACION_DE_NUMERO_INGRESO_.name())
                .event(AccionesProvidencia.CREAR_PROVIDENCIA.name())
                .and()
                .withExternal()
...
//                .and()
                ...
                .withExternal()
                .source(EstadoProvidencia.NUEVA_PROVIDENCIA.name()).target(EstadoProvidencia.REVISA_PRONUNCIAMIENTO.name())
                .event(AccionesProvidencia.FLUJO_SANCION.name())
                .and()
                .withExternal()
