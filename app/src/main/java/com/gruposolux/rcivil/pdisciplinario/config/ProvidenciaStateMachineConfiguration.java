...
//     ----------------------------------  prorroga  ----------------------------------------------------------------------
            .withExternal()
            .source(EstadoProvidencia.DGD_RECEPCIONA.name()).target(EstadoProvidencia.UPD_ELABORA_NOTIFICACION_PRORROGA.name())
            .event(AccionesProvidencia.PRORROGA.name())
            .and()
            .withExternal()
            .source(EstadoProvidencia.UPD_ELABORA_NOTIFICACION_PRORROGA.name()).target(EstadoProvidencia.SECRETARIA_REVISA_NOTIFICACION.name())
            .event(AccionesProvidencia.PRORROGA.name())
            .and()
            .withExternal()
            .source(EstadoProvidencia.SECRETARIA_REVISA_NOTIFICACION.name()).target(EstadoProvidencia.ESPERANDO_FIRMA_DE_SUBDIRECCION_A_NOTIFICACION_PRORROGA.name())
            .event(AccionesProvidencia.PRORROGA.name())
            .and()
            .withExternal()
            .source(EstadoProvidencia.ESPERANDO_FIRMA_DE_SUBDIRECCION_A_NOTIFICACION_PRORROGA.name()).target(EstadoProvidencia.SECRETARIA_REVISA_FIRMA_NOTIFICACION.name())
            .event(AccionesProvidencia.PRORROGA.name())
            .and()
            .withExternal()
            .source(EstadoProvidencia.SECRETARIA_REVISA_FIRMA_NOTIFICACION.name()).target(EstadoProvidencia.UPD_NOTIFICA_PRORROGA_FISCAL.name())
            .event(AccionesProvidencia.PRORROGA.name())
            .and()
            .withExternal()
            .source(EstadoProvidencia.UPD_NOTIFICA_PRORROGA_FISCAL.name()).target(EstadoProvidencia.DGD_DESPACHA_NOTIFICACION_PRORROGA_FISCAL.name())
            .event(AccionesProvidencia.PRORROGA.name())
            .and()
            .withExternal()
            .source(EstadoProvidencia.DGD_DESPACHA_NOTIFICACION_PRORROGA_FISCAL.name()).target(EstadoProvidencia.INVESTIGACION.name())
            .event(AccionesProvidencia.PRORROGA.name())
            .and()
            //     ----------------------------------  prorroga2  ----------------------------------------------------------------------
            .withExternal()
             ...
             */
            .withExternal()
            .source(EstadoProvidencia.INVESTIGACION.name()).target(EstadoProvidencia.PETICION_PRORROGA.name())
            .event(AccionesProvidencia.PRORROGA.name())
//            .event(AccionesProvidencia.FISCAL_RECHAZA.name())
           //
            .and()
