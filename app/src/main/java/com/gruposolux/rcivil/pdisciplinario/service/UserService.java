...
import com.gruposolux.rcivil.pdisciplinario.service.util.RandomUtil;
import com.gruposolux.rcivil.pdisciplinario.web.rest.errors.EmailAlreadyUsedException;
import com.gruposolux.rcivil.pdisciplinario.web.rest.errors.InvalidPasswordException;
...
//                managedAuthorities.clear();
    ...
    public User getCurrentUser() {
        return userRepository
            .findOneByLogin(SecurityUtils.getCurrentUserLogin2())
            .orElse(null);
    }
    ...
    public UserResponseDTO changeActivationStatus(UserActivateDTO userActivateDTO)
    {
        if (userActivateDTO != null)
        {
            if (userActivateDTO.getId() != null && userActivateDTO.getActivated() != null)
            {
                ...
                User user = this.userRepository.getOne(userActivateDTO.getId());
