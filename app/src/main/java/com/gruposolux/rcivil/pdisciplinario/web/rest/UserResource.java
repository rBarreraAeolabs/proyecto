...
import com.gruposolux.rcivil.pdisciplinario.service.MailService;
import com.gruposolux.rcivil.pdisciplinario.service.UserService;
import com.gruposolux.rcivil.pdisciplinario.service.dto.UserActivateDTO;
import com.gruposolux.rcivil.pdisciplinario.service.dto.UserDTO;
import com.gruposolux.rcivil.pdisciplinario.service.dto.UserResponseDTO;
import com.gruposolux.rcivil.pdisciplinario.web.rest.errors.EmailAlreadyUsedException;
import com.gruposolux.rcivil.pdisciplinario.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            throw new BadRequestAlertException("Un nuevo usuario no puede tener una identificación", "userManagement", "existente");
            ...
            return ResponseEntity.created(new URI("/api/users/" + newUser.getLogin()))
                .headers(HeaderUtil.createAlert("Usuario creado exitosamente", newUser.getLogin()))
                .body(newUser);
        }
    }
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        return ResponseUtil.wrapOrNotFound(updatedUser,
            HeaderUtil.createAlert("Usuario actualizado exitosamente", userDTO.getLogin()));
    }

    @PutMapping("/users/activate")
    @Timed
    public ResponseEntity<UserResponseDTO> changeActivationStatus(@Valid @RequestBody UserActivateDTO userActivateDTO) {
        UserResponseDTO userResponseDTO = this.userService.changeActivationStatus(userActivateDTO);
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable String login) {
        ...
        return ResponseEntity.ok().headers(HeaderUtil.createAlert("Usuario eliminado exitosamente", login)).build();
    }

    @GetMapping("/users/dgdp")
    @Timed
    public ResponseEntity<Boolean> verifyUserDgdp() {
        return new ResponseEntity<>(this.userService.verifyUserDgdp(), HttpStatus.OK);
    }
}
