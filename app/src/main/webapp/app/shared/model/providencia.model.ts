...
export const enum EstadoProvidencia {
    ...
    INVESTIGACION_CERRADA= 'INVESTIGACION_CERRADA',
    ASESOR_DN= 'ASESOR_DN',
...
export const enum AccionesProvidencia {
    ...
    NOTIFICA_E_INFORMA_SENSURA = 'NOTIFICA_E_INFORMA_SENSURA',
    NOTIFICA_E_INFORMA_DESTITUCION= 'NOTIFICA_E_INFORMA_DESTITUCION',
    REALIZAR_NOTIFICACIONES= 'REALIZAR_NOTIFICACIONES',
    ENVIA_VISTA_FISCAL_A_DN__= 'ENVIA_VISTA_FISCAL_A_DN__',
