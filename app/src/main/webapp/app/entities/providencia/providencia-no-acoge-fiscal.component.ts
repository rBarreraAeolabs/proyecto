...
@Component({
    selector: 'jhi-providencia-no-acoge-fiscal',
    templateUrl: './providencia-no-acoge-fiscal.component.html'
})
export class ProvidenciaNoAcogeFiscalComponent implements OnInit {
    ...
    noAcogeFiscal(id: number) {
        ...
        this.providenciaResponse.observacion = this.observacionDerivacion;
            ...
            this.providenciaService.noAcogeFiscal(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-no-acoge-fiscal-popup',
    template: ''
})
export class ProvidenciaNoAcogeFiscalPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaNoAcogeFiscalComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
