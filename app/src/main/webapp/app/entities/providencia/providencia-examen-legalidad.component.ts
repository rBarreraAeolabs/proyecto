...
@Component({
    selector: 'jhi-providencia-examen-legalidad',
    templateUrl: './providencia-examen-legalidad.component.html'
})
export class ProvidenciaExamenLegalidadComponent implements OnInit {
    ...
    examenLegalidad(id: number ) {
        ...
        this.providenciaService.examenLegalidad(this.providenciaResponse).subscribe(res => {
            this.eventManager.broadcast({
                name: 'providenciaListModification',
                content: 'Providencia examen legalidad'
            });
...
@Component({
    selector: 'jhi-providencia-examen-legalidad-popup',
    template: ''
})
export class ProvidenciaExamenLegalidadPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaExamenLegalidadComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
