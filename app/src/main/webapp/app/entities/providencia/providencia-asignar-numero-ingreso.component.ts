...
@Component({
    selector: 'jhi-providencia-asignar-numero-ingreso',
    templateUrl: './providencia-asignar-numero-ingreso.component.html'
})
export class ProvidenciaAsignarNumeroIngresoComponent implements OnInit {
    ...
    asignarNumeroIngreso() {
        this.providenciaService.asignarNumeroIngreso(this.providenciaUpdateNroReferencia)
            .subscribe(
...
export class  ProvidenciaAsignarNumeroIngresoPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaAsignarNumeroIngresoComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
