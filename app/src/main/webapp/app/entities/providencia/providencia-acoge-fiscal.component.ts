...
@Component({
    selector: 'jhi-providencia-acoge-fiscal',
    templateUrl: './providencia-acoge-fiscal.component.html'
})
export class ProvidenciaAcogeFiscalComponent implements OnInit {
    ...
    acogeFiscal(id: number) {
        ...
        this.providenciaResponse.observacion = this.observacionDerivacion;
            ...
            this.providenciaService.acogeFiscal(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-acoge-fiscal-popup',
    template: ''
})
export class ProvidenciaAcogeFiscalPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaAcogeFiscalComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
