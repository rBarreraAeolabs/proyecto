...
@Component({
    selector: 'jhi-providencia-notifica-dgdp',
    templateUrl: './providencia-notifica-dgdp.component.html'
})
export class ProvidenciaNotificaDgdpComponent implements OnInit {
    ...
    notificaDgdp(id: number) {
        ...
        this.providenciaService.notificaDgdp(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-notifica-dgdp-popup',
    template: ''
})
export class ProvidenciaNotificaDgdpPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaNotificaDgdpComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
