...
@Component({
    selector: 'jhi-providencia-representa',
    templateUrl: './providencia-representa.component.html'
})
export class  ProvidenciaRepresentaComponent implements OnInit {
    ...
    representa(id: number ) {
        ...
        this.providenciaService.representa(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-representa-popup',
    template: ''
})
export class ProvidenciaRepresentaPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaRepresentaComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
