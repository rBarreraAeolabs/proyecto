...
@Component({
    selector: 'jhi-providencia-enviar-informe-memo',
    templateUrl: './providencia-enviar-informe.component.html'
})
export class ProvidenciaEnviarInformeComponent implements OnInit {
    ...
    enviarInforme(id: number) {
        ...
        this.providenciaService.enviarInforme(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-enviar-informe-popup',
    template: ''
})
export class ProvidenciaEnviarInformePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaEnviarInformeComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
