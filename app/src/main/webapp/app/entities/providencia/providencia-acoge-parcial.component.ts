...
@Component({
    selector: 'jhi-providencia-acoge-parcial',
    templateUrl: './providencia-acoge-parcial.component.html'
})
export class ProvidenciaAcogeParcialComponent implements OnInit {
    ...
    acogeParcial(id: number) {
        ...
        this.providenciaResponse.observacion = this.observacionDerivacion;
            ...
            this.providenciaService.acogeParcial(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-acoge-parcial-popup',
    template: ''
})
export class ProvidenciaAcogeParcialPopupComponent implements OnInit, OnDestroy {
