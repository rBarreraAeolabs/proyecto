...
export class ProvidenciaElevarsumarioAdministrativoPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaElevarsumarioAdministrativoComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
