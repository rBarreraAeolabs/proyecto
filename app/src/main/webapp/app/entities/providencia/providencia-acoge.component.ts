...
@Component({
    selector: 'jhi-providencia-acoge',
    templateUrl: './providencia-acoge.component.html'
})
export class ProvidenciaAcogeComponent implements OnInit {
    ...
    acoge(id: number) {
        ...
        this.providenciaResponse.observacion = this.observacionDerivacion;
            ...
            this.providenciaService.acoge(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-acoge-popup',
    template: ''
})
export class ProvidenciaAcogePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaAcogeComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
