...
@Component({
    selector: 'jhi-providencia-emite',
    templateUrl: './providencia-emite.component.html'
})
export class ProvidenciaEmiteComponent implements OnInit {
    ...
    emiteProvidencia(id: number) {
        ...
        this.providenciaService.emiteProvidencia (this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-emite-popup',
    template: ''
})
export class ProvidenciaEmitePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaEmiteComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
