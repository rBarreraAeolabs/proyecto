...
@Component({
    selector: 'jhi-providencia-suspension',
    templateUrl: './providencia-suspension.component.html'
})
export class ProvidenciaSuspensionComponent implements OnInit {
    ...
    suspension(id: number) {
        ...
        this.providenciaService.suspension(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-suspension-popup',
    template: ''
})
export class ProvidenciaSuspensionPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaSuspensionComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
