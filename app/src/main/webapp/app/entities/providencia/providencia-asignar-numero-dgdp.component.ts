...
@Component({
    selector: 'jhi-providencia-asignar-numero-dgdpp',
    templateUrl: './providencia-asignar-numero-dgdp.component.html'
})
export class ProvidenciaAsignarNumeroDgdpComponent implements OnInit {
    ...
    asignarNumeroDGDP() {
        this.providenciaService.asignarNumeroDGDP(this.providenciaUpdateNroReferencia)
            .subscribe(
...
@Component({
    selector: 'jhi-providencia-asignar-numero-dgdp-popup',
    template: ''
})
export class  ProvidenciaAsignarNumeroDgdpPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaAsignarNumeroDgdpComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
