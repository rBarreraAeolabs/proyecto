...
@Component({
    selector: 'jhi-providencia-sin-denunciante',
    templateUrl: './providencia-sin-denunciante.component.html'
})
export class ProvidenciaSinDenuncianteComponent implements OnInit {
    ...
    sinDenunciante(id: number) {
        ...
        this.providenciaService.sinDenunciante(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-sin-denunciante-popup',
    template: ''
})
export class ProvidenciaSinDenunciantePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaSinDenuncianteComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
