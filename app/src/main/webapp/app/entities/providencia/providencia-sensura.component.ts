...
@Component({
    selector: 'jhi-providencia-sensura',
    templateUrl: './providencia-sensura.component.html'
})
export class ProvidenciaSensuraComponent implements OnInit {
    ...
    sensura(id: number) {
        ...
        this.providenciaService.sensura(this.providenciaResponse).subscribe(res => {
            this.eventManager.broadcast({
                name: 'providencia',
                content: 'Providencia censura'
            });
...
@Component({
    selector: 'jhi-providencia-sensura-popup',
    template: ''
})
export class ProvidenciaSensuraPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaSensuraComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
