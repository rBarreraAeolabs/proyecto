...
@Component({
    selector: 'jhi-providencia-no-propone',
    templateUrl: './providencia-no-propone.component.html'
})
export class ProvidenciaNoProponeComponent implements OnInit {
    ...
    noPropone(id: number ) {
        ...
        this.providenciaService.noPropone(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-no-propone-popup',
    template: ''
})
export class ProvidenciaNoProponePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaNoProponeComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
