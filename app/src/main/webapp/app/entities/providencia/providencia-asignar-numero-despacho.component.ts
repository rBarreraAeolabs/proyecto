...
@Component({
    selector: 'jhi-providencia-asignar-numero-despacho',
    templateUrl: './providencia-asignar-numero-despacho.component.html'
})
export class ProvidenciaAsignarNumeroDespachoComponent implements OnInit {
    ...
    asignarNumeroDespacho() {
        this.providenciaService.asignarNumeroDespacho(this.providenciaUpdateNroReferencia)
            .subscribe(
...
@Component({
    selector: 'jhi-providencia-asignar-numero-despacho-popup',
    template: ''
})
export class  ProvidenciaAsignarNumeroDespachoPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaAsignarNumeroDespachoComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
