...
@Component({
    selector: 'jhi-providencia-toma-razon',
    templateUrl: './providencia-toma-razon.component.html'
})
export class  ProvidenciaTomaRazonComponent implements OnInit {
    ...
    tomaRazon(id: number ) {
        ...
        this.providenciaService.tomaRazon(this.providenciaResponse).subscribe(res => {
            this.eventManager.broadcast({
                name: 'providenciaListModification',
                content: 'Providencia toma razon'
            });
...
@Component({
    selector: 'jhi-providencia-tomar-razon-popup',
    template: ''
})
export class ProvidenciaTomaRazonPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaTomaRazonComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
