...
@Component({
    selector: 'jhi-providencia-destitucion',
    templateUrl: './providencia-destitucion.component.html'
})
export class ProvidenciaDestitucionComponent implements OnInit {
    ...
    destitucion(id: number) {
        ...
        this.providenciaService.destitucion(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-multa-popup',
    template: ''
})
export class ProvidenciaDestitucionPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaDestitucionComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
