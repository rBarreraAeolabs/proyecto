...
@Component({
    selector: 'jhi-providencia-registra',
    templateUrl: './providencia-registra.component.html'
})
export class  ProvidenciaRegistraComponent implements OnInit {
    ...
    registra(id: number ) {
        ...
        this.providenciaService.registra(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-registra-popup',
    template: ''
})
export class ProvidenciaRegistraPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaRegistraComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
