...
@Component({
    selector: 'jhi-providencia-envia-vista-fiscal',
    templateUrl: './providencia-envia-vista-fiscal.component.html'
})
export class ProvidenciaEnviaVistaFiscalComponent implements OnInit {
    ...
    enviaVistaFiscal(id: number) {
        ...
        this.providenciaService.enviaVistaFiscal(this.providenciaResponse).subscribe(res => {
            this.eventManager.broadcast({
                name: 'providenciaProrroga',
                content: 'Providencia envia vista fiscal'
            });
...
@Component({
    selector: 'jhi-providencia-envia-vista-fiscal-popup',
    template: ''
})
export class ProvidenciaEnviaVistaFiscalPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaEnviaVistaFiscalComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
