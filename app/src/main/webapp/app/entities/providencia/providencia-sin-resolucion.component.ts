...
@Component({
    selector: 'jhi-providencia-sin-resolucion',
    templateUrl: './providencia-sin-resolucion.component.html'
})
export class ProvidenciaSinResolucionComponent implements OnInit {
    ...
    alcanceSinResolucion(id: number ) {
        ...
        this.providenciaService.alcanceSinResolucion
        (this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-sin-resolucion-popup',
    template: ''
})
export class ProvidenciaSinResolucionPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaSinResolucionComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
