...
@Component({
    selector: 'jhi-providencia-alcance',
    templateUrl: './providencia-alcance.component.html'
})
export class ProvidenciaAlcanceComponent implements OnInit {
    ...
    alcance(id: number ) {
        ...
        this.providenciaService.alcance(this.providenciaResponse).subscribe(res => {
...
@Component({
    selector: 'jhi-providencia-alcance-popup',
    template: ''
})
export class ProvidenciaAlcancePopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaAlcanceComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
