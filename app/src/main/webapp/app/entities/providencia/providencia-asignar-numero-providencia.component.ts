...
@Component({
    selector: 'jhi-providencia-asignar-numero-providencia',
    templateUrl: './providencia-asignar-numero-providencia.component.html'
})
export class ProvidenciaAsignarNumeroProvidenciaComponent implements OnInit {
    ...
    asignarNumeroProvidencia() {
        this.providenciaService.asignarNumeroProvidencia(this.providenciaUpdateNroReferencia)
            .subscribe(
...
@Component({
    selector: 'jhi-providencia-asignar-numero-providencia-popup',
    template: ''
})
export class  ProvidenciaAsignarNumeroProvidenciaPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaAsignarNumeroProvidenciaComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
