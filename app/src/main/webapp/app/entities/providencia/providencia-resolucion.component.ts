...
@Component({
    selector: 'jhi-providencia-resolucion ',
    templateUrl: './providencia-resolucion.component.html'
})
export class ProvidenciaResolucionComponent implements OnInit {
    ...
    resolucion(id: number ) {
        ...
        this.providenciaService.resolucion (this.providenciaResponse).subscribe(res => {
            this.eventManager.broadcast({
                name: 'providenciaListModification',
                content: 'Providencia resolucion'
            });
...
@Component({
    selector: 'jhi-providencia-resolucion-popup',
    template: ''
})
export class ProvidenciaResolucionPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.activatedRoute.data.subscribe(({ providencia }) => {
            setTimeout(() => {
                this.ngbModalRef = this.modalService.open(ProvidenciaResolucionComponent as Component, {
                    size: 'lg',
                    backdrop: 'static'
                });
